<template>
	<view class="container">
		...
		<view class="form_list">
			...
			<view class="form_item flex_y_center">
				...
				<view class="flex_y_center fi_item" style="margin-left: auto;">
					<input @input="getOrg" type="text" :value="formdata.orgName" placeholder="请输入" placeholder-style="color:#cecece;"/>
					<image src="../../static/images/user3.png" mode=""></image>
				</view>
			</view>
			<view class="form_item flex_y_center">
				<view>就诊科室：</view>
				<view class="flex_y_center fi_item" style="margin-left: auto;">
					<input @input="getDept" type="text" :value="formdata.dept" placeholder="请输入" placeholder-style="color:#cecece;"/>
					<image src="../../static/images/user3.png" mode=""></image>
				</view>
			</view>
			<view class="form_item flex_y_center">
				<view>医生姓名：</view>
				<view class="flex_y_center fi_item" style="margin-left: auto;">
					<input @input="getDoc" type="text" :value="formdata.doctorName" placeholder="请输入" placeholder-style="color:#cecece;"/>
					<image src="../../static/images/user3.png" mode=""></image>
				</view>
			</view>
		</view>
		<view class="form_list">
			<view class="textarea">
				<view>病情描述：</view>
				<textarea @input="getDesc" :value="formdata.medicalDesc" placeholder="请详细描述你的疾病主要症状、身体感受、持续时间等问题。" />
			</view>
		...
		<view class="form_list">
			...
			<view class="form_item">
				<input @input="getRemark" type="text" :value="formdata.remark" placeholder="请输入实体医院确诊疾病名称" />
			</view>
		</view>
...
<script>
	...
	export default {
		...
		onLoad(options) {
			let formdata = uni.getStorageSync('medical_item')
			formdata = JSON.parse(formdata)
			formdata.findTime = formdata.findTime.split(' ')[0]
			// for(let i in formdata.imageDTO){
			// 	delete formdata.imageDTO[i].otherId
			// }
		...
		methods: {
			confirm(){
				...
				uni.request({
					url:that.$api.healthRecord.updateMedical,
					method:"post",
					header:{
